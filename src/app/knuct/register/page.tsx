          ...
          {!mounted ? (
            ...
            <div className="rounded-lg border border-green-200 bg-green-50 p-6 text-center space-y-3">
              ...
              <p className="text-sm text-green-700">
                ...
                After approval, open the Knuct console, download your private share, then sign in with DID.
              </p>
              <Button asChild className="text-white hover:opacity-90" style={{ backgroundColor: general.brandingPrimaryColor }}>
                <Link href="/knuct/login">Back to Knuct login</Link>
              </Button>
            </div>
          ) : (
            <>
              <Tabs defaultValue="create">
                ...
                <TabsContent value="create" className="space-y-4 mt-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Submit your profile for Knuct console operator approval. Your wallet is created on approval — then download your private share from /knuct.
                  </p>
                  {createError && (
              ...
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/knuct/login" className="text-brand font-medium hover:underline">
                  Knuct sign in
                </Link>
              </p>
            </>
