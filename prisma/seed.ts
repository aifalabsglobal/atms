...
async function main() {
  console.log('🌱 Seeding AIMSCS database with R22 Regulation data...');
  ...
  // ==========================================
  // 1. DEPARTMENTS (AIMSCS)
  // ==========================================
  console.log('📦 Creating departments...');
  const departments = await Promise.all([
    db.department.create({ data: { name: 'Computer Science & Engineering', code: 'CSE', building: 'CSE Block', floor: '1-3', phone: '+91-40-23158661', email: 'cse@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'CSE (Artificial Intelligence & Machine Learning)', code: 'CSE-AIML', building: 'CSE Block', floor: '4', phone: '+91-40-23158662', email: 'aiml@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'CSE (Data Science)', code: 'CSE-DS', building: 'CSE Block', floor: '4', phone: '+91-40-23158663', email: 'ds@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'CSE (Networks)', code: 'CSE-NT', building: 'CSE Block', floor: '3', phone: '+91-40-23158664', email: 'nt@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Electronics & Communication Engineering', code: 'ECE', building: 'ECE Block', floor: '1-3', phone: '+91-40-23158665', email: 'ece@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Electrical & Electronics Engineering', code: 'EEE', building: 'EEE Block', floor: '1-2', phone: '+91-40-23158666', email: 'eee@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Mechanical Engineering', code: 'MECH', building: 'MECH Block', floor: '1-2', phone: '+91-40-23158667', email: 'mech@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Civil Engineering', code: 'CIVIL', building: 'CIVIL Block', floor: '1-2', phone: '+91-40-23158668', email: 'civil@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Information Technology', code: 'IT', building: 'IT Block', floor: '1-2', phone: '+91-40-23158669', email: 'it@aimscs.ac.in', isActive: true } }),
    db.department.create({ data: { name: 'Computer Science & Applied Mathematics', code: 'CSAM', building: 'CSE Block', floor: '5', phone: '+91-40-23158670', email: 'csam@aimscs.ac.in', isActive: true } }),
  ]);
  ...
  // ==========================================
  // 4. SUBJECTS (AIMSCS R22 CSE pattern)
  // ==========================================
  ...
  const usersData = [
    ...
    // HODs (one per dept)
    { id: 'u3', email: 'hod.cse@aimscs.ac.in', name: 'Dr. A. Vinaya Babu', employeeId: 'AIMSCS003', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'hod' as const, status: 'active', phone: '+91-9876543203', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4', email: 'hod.aiml@aimscs.ac.in', name: 'Dr. B. Rama Devi', employeeId: 'AIMSCS004', departmentId: aimlDept.id, department: 'CSE (AIML)', role: 'hod' as const, status: 'active', phone: '+91-9876543204', profileImageUrl: '/profiles/staff-female-faculty.png' },
    { id: 'u4b', email: 'hod.ds@aimscs.ac.in', name: 'Dr. C. Shoba Bindu', employeeId: 'AIMSCS005', departmentId: dsDept.id, department: 'CSE (Data Science)', role: 'hod' as const, status: 'active', phone: '+91-9876543205', profileImageUrl: '/profiles/staff-female-faculty.png' },
    { id: 'u4c', email: 'hod.nt@aimscs.ac.in', name: 'Dr. D. Sreenu Naik', employeeId: 'AIMSCS006', departmentId: ntDept.id, department: 'CSE (Networks)', role: 'hod' as const, status: 'active', phone: '+91-9876543206', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4d', email: 'hod.ece@aimscs.ac.in', name: 'Dr. E. Nagabhooshanam', employeeId: 'AIMSCS007', departmentId: eceDept.id, department: 'Electronics & Communication Engineering', role: 'hod' as const, status: 'active', phone: '+91-9876543207', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4e', email: 'hod.eee@aimscs.ac.in', name: 'Dr. F. Suresh Babu', employeeId: 'AIMSCS008', departmentId: eeeDept.id, department: 'Electrical & Electronics Engineering', role: 'hod' as const, status: 'active', phone: '+91-9876543208', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4f', email: 'hod.mech@aimscs.ac.in', name: 'Dr. G. Krishna Mohana Rao', employeeId: 'AIMSCS009', departmentId: mechDept.id, department: 'Mechanical Engineering', role: 'hod' as const, status: 'active', phone: '+91-9876543209', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4g', email: 'hod.civil@aimscs.ac.in', name: 'Dr. H. Ramesh Kumar', employeeId: 'AIMSCS010', departmentId: civilDept.id, department: 'Civil Engineering', role: 'hod' as const, status: 'active', phone: '+91-9876543210', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4h', email: 'hod.it@aimscs.ac.in', name: 'Dr. I. Ramesh Reddy', employeeId: 'AIMSCS011', departmentId: itDept.id, department: 'Information Technology', role: 'hod' as const, status: 'active', phone: '+91-9876543211', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u4i', email: 'hod.csam@aimscs.ac.in', name: 'Dr. J. Srinivasa Rao', employeeId: 'AIMSCS012', departmentId: csamDept.id, department: 'Computer Science & Applied Mathematics', role: 'hod' as const, status: 'active', phone: '+91-9876543212', profileImageUrl: '/profiles/staff-male-faculty.png' },
    // Faculty
    { id: 'u6', email: 'faculty.venkat@aimscs.ac.in', name: 'Prof. Venkat Ramana', employeeId: 'AIMSCS013', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'faculty' as const, status: 'active', phone: '+91-9876543213', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u6b', email: 'faculty.lakshmi@aimscs.ac.in', name: 'Dr. Lakshmi Devi', employeeId: 'AIMSCS014', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'faculty' as const, status: 'active', phone: '+91-9876543214', profileImageUrl: '/profiles/staff-female-faculty.png' },
    { id: 'u6c', email: 'faculty.srinivas@aimscs.ac.in', name: 'Dr. Srinivas Reddy', employeeId: 'AIMSCS015', departmentId: eceDept.id, department: 'Electronics & Communication Engineering', role: 'faculty' as const, status: 'active', phone: '+91-9876543215', profileImageUrl: '/profiles/staff-male-faculty.png' },
    { id: 'u6d', email: 'faculty.padma@aimscs.ac.in', name: 'Prof. Padmavathi', employeeId: 'AIMSCS016', departmentId: eceDept.id, department: 'Electronics & Communication Engineering', role: 'faculty' as const, status: 'active', phone: '+91-9876543216', profileImageUrl: '/profiles/staff-female-faculty.png' },
    // Lab Assistant
    { id: 'u8', email: 'lab.ravi@aimscs.ac.in', name: 'Ravi Teja K.', employeeId: 'AIMSCS017', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'lab_assistant' as const, status: 'active', phone: '+91-9876543217', profileImageUrl: '/profiles/staff-male-faculty.png' },
    // Students
    { id: 'u10', email: 'student.ravi@aimscs.ac.in', name: 'Arun Kumar', employeeId: 'STU001', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543218', profileImageUrl: '/profiles/student-male-1.png' },
    { id: 'u10b', email: 'student.divya@aimscs.ac.in', name: 'Divya Sri', employeeId: 'STU002', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543219', profileImageUrl: '/profiles/student-female-1.png' },
    { id: 'u10c', email: 'student.sai@aimscs.ac.in', name: 'Sai Prasad', employeeId: 'STU003', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543220', profileImageUrl: '/profiles/student-male-1.png' },
    { id: 'u10d', email: 'student.priyanka@aimscs.ac.in', name: 'Priyanka Reddy', employeeId: 'STU004', departmentId: eceDept.id, department: 'Electronics & Communication Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543221', profileImageUrl: '/profiles/student-female-2.png' },
    { id: 'u10e', email: 'student.naveen@aimscs.ac.in', name: 'Naveen Kumar', employeeId: 'STU005', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543222', profileImageUrl: '/profiles/student-male-1.png' },
    { id: 'u10f', email: 'student.anusha@aimscs.ac.in', name: 'Anusha Devi', employeeId: 'STU006', departmentId: eceDept.id, department: 'Electronics & Communication Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543223', profileImageUrl: '/profiles/student-female-2.png' },
    { id: 'u10g', email: 'student.mahesh@aimscs.ac.in', name: 'Mahesh Babu', employeeId: 'STU007', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'active', phone: '+91-9876543224', profileImageUrl: '/profiles/student-male-1.png' },
    { id: 'u10h', email: 'student.sireesha@aimscs.ac.in', name: 'Sireesha Kumari', employeeId: 'STU008', departmentId: itDept.id, department: 'Information Technology', role: 'student' as const, status: 'active', phone: '+91-9876543225', profileImageUrl: '/profiles/student-female-1.png' },
    { id: 'u10i', email: 'student.irfan@aimscs.ac.in', name: 'Irfan Khan', employeeId: 'STU009', departmentId: cseDept.id, department: 'Computer Science & Engineering', role: 'student' as const, status: 'suspended', phone: '+91-9876543226', profileImageUrl: '/profiles/student-male-1.png' },
    // Parent
    { id: 'u18', email: 'parent.rajesh@aimscs.ac.in', name: 'Mr. Rajesh Kumar', department: 'N/A', role: 'parent' as const, status: 'active', phone: '+91-9876543227', linkedStudentId: 'u10', profileImageUrl: '/profiles/staff-male-admin.png' },
    // Visitor
    { id: 'u19', email: 'visitor.john@aimscs.ac.in', name: 'John Smith', department: 'External', role: 'visitor' as const, status: 'active', phone: '+91-9876543228', profileImageUrl: '/profiles/staff-male-faculty.png' },
    // Security
    { id: 'u20', email: 'security.murthy@aimscs.ac.in', name: 'Murthy Garu', employeeId: 'SEC001', department: 'Security', role: 'security' as const, status: 'active', phone: '+91-9876543229', profileImageUrl: '/profiles/staff-male-faculty.png' },
  ];
  ...
  const hodDeptPairs: Array<[typeof cseDept, string]> = [
    [cseDept, 'hod.cse@aimscs.ac.in'],
    [aimlDept, 'hod.aiml@aimscs.ac.in'],
    [dsDept, 'hod.ds@aimscs.ac.in'],
    [ntDept, 'hod.nt@aimscs.ac.in'],
    [eceDept, 'hod.ece@aimscs.ac.in'],
    [eeeDept, 'hod.eee@aimscs.ac.in'],
    [mechDept, 'hod.mech@aimscs.ac.in'],
    [civilDept, 'hod.civil@aimscs.ac.in'],
    [itDept, 'hod.it@aimscs.ac.in'],
    [csamDept, 'hod.csam@aimscs.ac.in'],
  ];
  ...
  const courseData = cseSubjects.map((subject, idx) => {
    ...
    return {
      ...
      semester: semNum,
      type: subject.type,
      description: `${subject.name} - ${subject.category || 'PC'} course as per AIMSCS R22 Regulation`,
  ...
  await db.auditLog.createMany({
    data: [
      ...
      { userId: adminUser.id, action: 'CREATE', resource: 'department', details: 'Created 10 departments for AIMSCS', ipAddress: '192.168.1.100' },
      { userId: adminUser.id, action: 'CREATE', resource: 'semester', details: 'Created 8 semesters for AY 2025-2026', ipAddress: '192.168.1.100' },
      { userId: adminUser.id, action: 'CREATE', resource: 'subject', details: 'Created subjects as per AIMSCS R22 Regulation CSE pattern', ipAddress: '192.168.1.100' },
